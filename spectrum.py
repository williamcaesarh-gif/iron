...
class BinanceFeed:
    ...
    def get_vpin_diagnostics(self, symbol):
        ...
        Returns a dict with:
          ...
          log_str  : pre-formatted " V:..%XX d30:.. d15:.. f:..%XX" for entry logs
        Components are None when their window has <$500 volume.
        """
        sym = symbol.upper()
        now = int(time.time())
        with self._lock:
        ...
        log_str = " " + " ".join([v_now, v_d30, v_d15, v_fast])
