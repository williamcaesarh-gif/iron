...
def reversal_monitor(pos, chainlink, binance, clob, open_positions, pos_lock, bal):
    ...
    while not pos["resolved"]:
        ...
        # VPIN removed — structural sell-side bias blocked UP flips
    ...
    try:
        while True:
            ...
            for mkt in markets:
                ...
                # VPIN removed — structural sell-side bias on Binance aggTrades
                # made it always show DN, blocking nearly all UP entries
                ...
                log(
                    ...
                    f"| P:{m_prob*100:.0f}% ask:{best_ask*100:.0f}c edge:{edge*100:.1f}c{imb_str}{vol_str} "
