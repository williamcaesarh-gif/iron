...
CONFIG = {
    ...
    # ── Sniper ──
    "sniper_start_s":     35,      # Start scanning 10s into window.
    "max_entry_price":    0.75,    # Never buy above 75c. Hard cap. Need ~76% WR to profit.
...
def main():
    ...
    SKIP_STAGES = {"no_ptb": 0, "no_feed": 1, "conv_low": 2, "chainlink_disagree": 3,
                   "no_book": 4, "max_price": 5, "no_edge": 6, "book_pressure": 7,
                   "vpin_low": 8, "vpin_disagree": 9, "has_pos": 10}
