...
CONFIG = {
    ...
    "conv_high":          0.0004,  # 0.04% — tradeable
    ...
    "vol_5m":             0.0008,  # assumed 5m price volatility for probability model
    ...
    try:
        while True:
            ...
            for mkt in markets:
                ...
                if edge < C["min_edge"]:
                    continue  # CLOB already priced in the move — no edge
                ...
                if imb is not None and imb < C["book_imbalance_min"]:
                    continue  # heavy ask-side pressure — MMs disagree
                ...
                log(
                    ...
                    f"| P:{m_prob*100:.0f}% ask:{best_ask*100:.0f}c edge:{edge*100:.1f}c{imb_str} "
